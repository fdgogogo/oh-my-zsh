...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/fdgogogo/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/fdgogogo/oh-my-zsh/master/tools/install.sh -O -)"
```
